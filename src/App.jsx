...
<button onClick={()=>{setEditId(c.id);setEditVal(String(c.budget))}} style={{background:"none",border:"none",color:T.textDim,cursor:"pointer",opacity:.4}}><Edit3 size={12}/></button></div>
)}</div></div>
